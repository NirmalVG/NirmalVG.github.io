    ...
    <footer id="contact" className="relative py-24 px-6">
      ...
      >
        ...
        >
          <a
            href="tel:9645826534"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl glass text-sm text-white/60 hover:text-neon-cyan hover:border-neon-cyan/30 transition-all duration-300"
          >
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="glass px-4 py-2 rounded-lg inline-flex items-center gap-2 text-xs text-white/40">
              ...
              <span>
                <span className="text-white/60 font-medium">BCA</span> — Amity University Online
                <span className="text-white/30 ml-1.5">July 2024 – Present</span>
              </span>
            </div>
          </div>
