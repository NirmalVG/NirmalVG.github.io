  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-theme-secondary text-sm sm:text-base mb-10 leading-relaxed max-w-md mx-auto break-words">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl glass text-sm text-theme-secondary">
            <svg
              className="w-4 h-4"
              fill="none"
              viewBox="0 0 24 24"
        ...
        >
          <a
            ...
            className="w-10 h-10 rounded-lg glass flex items-center justify-center icon-theme hover:border-neon-purple/30 transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.2)]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-lg glass flex items-center justify-center icon-theme hover:border-neon-cyan/30 transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,214,212,0.2)]"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <motion.div
          className="pt-8 border-t border-theme-subtle"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="glass px-3 sm:px-4 py-2 rounded-lg inline-flex items-center gap-2 text-xs text-theme-tertiary flex-wrap break-words">
              <span className="text-sm">🎓</span>
              <span>
                <span className="text-theme-secondary font-medium">BCA</span> — Amity
                University Online
                <span className="text-theme-tertiary ml-1.5">
                  July 2024 – Present
                </span>
              </span>
            </div>
